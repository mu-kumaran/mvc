...
function App()
{
  ...
  function insertfun(){
    ...
    axios.get("http://127.0.0.1:1234",{params:inputs}).then((res)=>{
        console.log(res)
  ...
  return(
    ...
    Roll no: <input type="text" placeholder="Enter roll no" name="rno" onChange={(e)=>dis(e)}></input><br></br>
    Student name : <input type="text" placeholder="Enter student name" name="sname" onChange={(e)=>dis(e)}></input><br></br>
    Mark: <input type="text" placeholder="Enter mark" name="mark" onChange={(e)=>dis(e)}></input><br></br>
    ...
    <h1>{list!==null && list._id !== null && "Successfully Inserted"}</h1>
    <h1>{list !== null && list._id !== null && "ID:"+list._id}</h1>
    </>
  )
}
export default App
